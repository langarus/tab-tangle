...
export function FilterDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className={`fixed bottom-8 right-8 z-50 w-14 h-14 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center font-semibold transform hover:scale-105 ${
          isFilterActive
            ...
            : "bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 border-2 border-gray-200 dark:border-gray-700"
        }`}
        title="Filters"
      >
        <svg
      ...
      {/* Dropdown Panel */}
      {isOpen && (
        <div className="fixed bottom-24 right-8 z-50 w-72 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
          <div className="p-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  searchParams?.duplicates ? "bg-amber-500" : "bg-gray-300 dark:bg-gray-700"
                }`}
              >
                <span
